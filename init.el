...
you should place your code here."
  ...
  ;; Set the startup directory to something more sensible
  (cd "~")
  ...
  ;; Show breadcrumbs for org-agenda
  ...
  (global-set-key (kbd "M-SPC") 'xah-math-input-change-to-symbol)
  ...
  (defun purescript-emmet ()
    ...
    (interactive)
    (let ((end (point))
          (start (save-excursion (beginning-of-line-text) (point))))
      (call-process-region start (+ 1 end) "purescript-emmet" t t)))
